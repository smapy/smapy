...
# -*- coding: utf-8 -*-
#
# Smapy documentation build configuration file, created by
...
author = 'Carles Sala'
description = 'Simple Modular APIs written in Python.'
user = 'csala'
...
version = smapy.__version__
# The full version, including alpha/beta/rc tags.
release = smapy.__version__
